      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <input
            ...
            className="flex-grow w-[7rem] pr-1 py-2 sm:w-[16rem] md:w-[20rem] text-lg rounded-sm outline-none md:py-2 md:pl-3 md:pr-8 md:text-xl bg-zinc-50 "
          />
        </form>
        <form className="sm:pl-1 md:mr-8 sm:pr-1 bg-[#31291D] sm:py-2 md:text-lg text-base text-slate-50 flex items-center justify-between md:gap-2 py-2  px-1 md:pl-1 lg:px-3 shadow-md">
          <div>
            <label className="pr-1 text-sm font-semibold md:text-lg md:text-md md-font-normal">
              Sort By{" "}
            </label>
          </div>
          <div>
